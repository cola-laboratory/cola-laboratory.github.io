...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.69d813cb2e0e08bd821bd2e06c8e4e657d12c7dfe7227d1006af6ad4b38884d7.js',function(){input.required=false;search();});}
