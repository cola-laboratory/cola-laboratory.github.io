...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.668078eb094a6a56aaecb7ace0683b4a1786bd5b1ae4709540d43897f5cd11a7.js',function(){input.required=false;search();});}
