...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.bd166d6c6104acdb4ac196ee85372a61d0af63329d6afe39f1f5d5dd371514e5.js',function(){input.required=false;search();});}
