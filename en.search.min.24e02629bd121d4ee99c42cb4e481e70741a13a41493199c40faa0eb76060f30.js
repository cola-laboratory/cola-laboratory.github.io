...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.7cf21434505947a7509617741ddfe3169d9a787f129fa3390f63c866463b1b5b.js',function(){input.required=false;search();});}
