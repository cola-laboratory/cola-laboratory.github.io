...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.8931d350ad26f19f68418561436f5744449cb67ae51adff7783732f463fcfc2a.js',function(){input.required=false;search();});}
