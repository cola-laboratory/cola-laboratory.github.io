...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.9b6959a2a727583281da3a8a791172362ef2fb10c7539a8cf16599a49b67086d.js',function(){input.required=false;search();});}
