...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.9503d71736db4fab87f1488af7fb9c828a557b0e0e7e497737586fb552511738.js',function(){input.required=false;search();});}
