...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f0cd81a1e2ba24f247279da32a782b17db4a65b282fed8cf80add0d05468adda.js',function(){input.required=false;search();});}
