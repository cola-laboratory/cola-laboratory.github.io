...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6252e9da8c30947164a7fa3485a43cd2eac2f2c808312d27e52567222e5a8a6e.js',function(){input.required=false;search();});}
