...
void evaluate_individual (individual_real *ind)
{
    ...
    (strcmp (problem_name, "DC1DTLZ1")  != 0)? :(dc1dtlz1 (ind), flag = 1);
    (strcmp (problem_name, "DC1DTLZ3")  != 0)? :(dc1dtlz3 (ind), flag = 1);
    (strcmp (problem_name, "DC2DTLZ1")  != 0)? :(dc2dtlz1 (ind), flag = 1);
    (strcmp (problem_name, "DC2DTLZ3")  != 0)? :(dc2dtlz3 (ind), flag = 1);
    (strcmp (problem_name, "DC3DTLZ1")  != 0)? :(dc3dtlz1 (ind), flag = 1);
    (strcmp (problem_name, "DC3DTLZ3")  != 0)? :(dc3dtlz3 (ind), flag = 1);
...
/* This is only useful for D-TAEA */
//int problem_update (int generation)
//{
//    int prerun = 300;
//    int gap = 100;
//
//    if((generation>=prerun)&&(generation%gap==0))
//    {
//        if(number_objective<7&&inc_flag)
//            number_objective++;
//        else{
//            inc_flag = 0;
//            number_objective --;
//            if(number_objective<2)number_objective = 2;
//        }
//        printf("\n number_objective:%d\n",number_objective);
//        return 1;
//    }
